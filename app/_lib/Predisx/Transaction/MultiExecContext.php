...
class MultiExecContext {
    ...
    private function onProtocolError($message) {
        ...
        // connection, we can safely assume that Predisx\Client::getConnection()
        // will always return an instance of Predisx\Network\IConnectionSingle.
